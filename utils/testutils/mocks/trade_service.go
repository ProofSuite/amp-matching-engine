...
func (_m *TradeService) Subscribe(conn *websocket.Conn, bt common.Address, qt common.Address) {
	_m.Called(conn, bt, qt)
}

// Unsubscribe provides a mock function with given fields: conn, bt, qt
func (_m *TradeService) Unsubscribe(conn *websocket.Conn, bt common.Address, qt common.Address) {
	_m.Called(conn, bt, qt)
}

// UpdateTradeTx provides a mock function with given fields: tr, tx
func (_m *TradeService) UpdateTradeTx(tr *types.Trade, tx *coretypes.Transaction) error {
	ret := _m.Called(tr, tx)
