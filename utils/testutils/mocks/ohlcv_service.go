...
func (_m *OHLCVService) Subscribe(conn *websocket.Conn, bt common.Address, qt common.Address, p *types.Params) {
	_m.Called(conn, bt, qt, p)
}

// Unsubscribe provides a mock function with given fields: conn, bt, qt, p
func (_m *OHLCVService) Unsubscribe(conn *websocket.Conn, bt common.Address, qt common.Address, p *types.Params) {
	_m.Called(conn, bt, qt, p)
}
