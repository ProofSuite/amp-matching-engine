...
func (_m *TokenServiceInterface) Create(token *types.Token) error {
	ret := _m.Called(token)
...
func (_m *TokenServiceInterface) GetAll() ([]types.Token, error) {
	ret := _m.Called()
...
func (_m *TokenServiceInterface) GetByAddress(addr common.Address) (*types.Token, error) {
	ret := _m.Called(addr)
...
func (_m *TokenServiceInterface) GetByID(id bson.ObjectId) (*types.Token, error) {
	ret := _m.Called(id)
