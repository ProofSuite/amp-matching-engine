...
// PairServiceInterface is an autogenerated mock type for the PairServiceInterface type
type PairServiceInterface struct {
	mock.Mock
}

// Create provides a mock function with given fields: pair
func (_m *PairServiceInterface) Create(pair *types.Pair) error {
	ret := _m.Called(pair)
...
func (_m *PairServiceInterface) GetAll() ([]types.Pair, error) {
	ret := _m.Called()
...
func (_m *PairServiceInterface) GetByID(id bson.ObjectId) (*types.Pair, error) {
	ret := _m.Called(id)
...
func (_m *PairServiceInterface) GetByTokenAddress(bt common.Address, qt common.Address) (*types.Pair, error) {
	ret := _m.Called(bt, qt)
