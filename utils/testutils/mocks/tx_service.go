...
// TxServiceInterface is an autogenerated mock type for the TxServiceInterface type
type TxServiceInterface struct {
	mock.Mock
}

// GetCustomTxSendOptions provides a mock function with given fields: w
func (_m *TxServiceInterface) GetCustomTxSendOptions(w *types.Wallet) *bind.TransactOpts {
	ret := _m.Called(w)
...
func (_m *TxServiceInterface) GetTxCallOptions() *bind.CallOpts {
	ret := _m.Called()
...
func (_m *TxServiceInterface) GetTxDefaultSendOptions(_a0 *bind.TransactOpts, _a1 error) {
	_m.Called(_a0, _a1)
}

// GetTxSendOptions provides a mock function with given fields:
func (_m *TxServiceInterface) GetTxSendOptions() (*bind.TransactOpts, error) {
	ret := _m.Called()
...
func (_m *TxServiceInterface) SetTxSender(w *types.Wallet) {
	_m.Called(w)
}
