...
func (_m *OrderBookService) Subscribe(conn *websocket.Conn, bt common.Address, qt common.Address) {
	_m.Called(conn, bt, qt)
}

// Unsubscribe provides a mock function with given fields: conn, bt, qt
func (_m *OrderBookService) Unsubscribe(conn *websocket.Conn, bt common.Address, qt common.Address) {
	_m.Called(conn, bt, qt)
}
