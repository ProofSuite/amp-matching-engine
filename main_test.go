...
func TestOrderbook(t *testing.T) {
	...
	engine.AddOrder(&Order{OrderType: SELL, Pair: BTC_USDT, Id: 1, Price: 50, Amount: 50})
	engine.AddOrder(&Order{OrderType: SELL, Pair: BTC_USDT, Id: 1, Price: 50, Amount: 50})
	engine.AddOrder(&Order{OrderType: SELL, Pair: BTC_USDT, Id: 2, Price: 45, Amount: 25})
	engine.AddOrder(&Order{OrderType: SELL, Pair: BTC_USDT, Id: 3, Price: 45, Amount: 25})
	engine.AddOrder(&Order{OrderType: BUY, Pair: BTC_USDT, Id: 4, Price: 55, Amount: 75})
	engine.CancelOrder(1, BTC_USDT)
	engine.AddOrder(&Order{OrderType: BUY, Pair: BTC_USDT, Id: 5, Price: 55, Amount: 20})
	engine.AddOrder(&Order{OrderType: BUY, Pair: BTC_USDT, Id: 6, Price: 50, Amount: 15})
	engine.AddOrder(&Order{OrderType: SELL, Pair: BTC_USDT, Id: 7, Price: 45, Amount: 25})
	engine.CloseOrderBookChannel(BTC_USDT)
